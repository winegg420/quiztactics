...
const YOLLAR = {
  ...
  sigorta: "M4 11a8 8 0 0 1 16 0H4Zm8 0v7a3 3 0 0 0 6 0",
  cifte: "M3 7h8l-3-3m3 3-3 3M13 17h8l-3-3m3 3-3 3",
  ikinciSans: "M20 7v5h-5M4 17v-5h5M6.1 8A7 7 0 0 1 18 6l2 1M17.9 16A7 7 0 0 1 6 18l-2-1",
  // Paket 32: Sis jokeri — bulut + altında iki sis dalgası
  sis: "M7.5 13.5a3.5 3.5 0 0 1 .3-7 5 5 0 0 1 9.4 1.6 3 3 0 0 1-.2 5.4zM3 17c1.5-1 3-1 4.5 0s3 1 4.5 0 3-1 4.5 0 3 1 4.5 0M6 20.5c1.5-1 3-1 4.5 0s3 1 4.5 0",
