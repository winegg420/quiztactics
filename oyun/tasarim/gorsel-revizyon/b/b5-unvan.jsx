...
function Liste() {
  return (
    <article className="gr-aday gr-aday--genis grb-un-tablo-kap">
      <header className="gr-aday-bas"><h3 className="qt-baslik-3">Unvan listesi — onay için (21)</h3></header>
...
export default function B5Unvan() {
  ...
  return (
    <GrBolum no={5} baslik="Unvan görünümü" tur="sec"
             aciklama="Unvan isim altında duran, kazanılan yazı. Yazı her zaman lacivert (koyu zeminde krem) — kontrast ≥ 7; tür rengi yalnız simgede, kurdele ucunda ve çizgide. Uzun unvan tek satır, sığmazsa '…'. Aşağıda iki stil ve onaylanacak 21 unvanlık liste."
             ic={4} gosterilen={2}
