...
- Biten: belge (a65bac4), sayfa kabuğu + ortak palet (8248eaf: `oyun/tasarim/gorsel-revizyon/` palet.js/palet.css, secim.jsx, a/, b/) · 6 lig çerçeveleri (B)
- Kalan: 0 stil rehberi (A) · 4 oyuncu kartı (B) · 1 coin (A) · 2 elmas (A) · 9 lig amblemleri (A) · 10 rozetler (A) · 7 level (B) · 8 turnuva (B) · 3 nadirlik (A) · 5 unvan (B) · 12 logo (A) · 11 joker hizalama (A) · 13 premium/arka plan hizalama (B)
